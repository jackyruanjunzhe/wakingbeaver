...
##Northeast
m.addConstr(mstwb *sumX['wb'] + mstb *sumX['b'] >= total_market_share * 0.135)
m.addConstr(mstwb *sumX['wb'] + mstb *sumX['b'] <= total_market_share * 0.165)
...
m.addConstrs(x.sum(citylist[i],'*') <= 1 for i in range(0,10))
